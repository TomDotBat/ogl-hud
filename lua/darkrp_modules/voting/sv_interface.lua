...
DarkRP.hookStub{
    ...
    returns = {
        ...
        {
            name = "callSuccess",
            description = "True if the callback for a successful vote should be called, false if the callback for a failed vote should be called. Only works when canStartVote is false.", --{{ script_version_name }}
            type = "boolean"
        },
        {
            name = "message",
